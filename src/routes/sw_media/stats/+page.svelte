...
<!-- Pie chart for owned and completed 
    Number owned vs not owned
    Number completed vs not completed
    Legends completed vs not completed
    canon completed vs not completed
    comic, games, books, seasons, or all
-->
